      ...
      <div className={`transition-opacity duration-500 ${activeDiv === 4 ? 'opacity-100' : 'opacity-0 hidden'}`}>
        <div className="mb-4 mt-10 flex flex-col items-center">
          ...
          <ul className="list-disc">
            ...
            <li>For Germany, data was analyzed throgh a close reading approach from the popular German online discussion forums of Heisse Online, TV Wunscliste Forum, and a Google search of Diskussion zur zweiten Staffel von Bridgerton.</li>
